...
use pallet_support::{
	...
	types::{
		...
		Position, ReferralDetails, Side, TradingAccount,
	},
};
...
fn test_fee_share_1() {
	...
	env.execute_with(|| {
		...
		print!(
			"\n\nmaster_fee_share: {:?}, {:?}\n\n",
			master_fee_share_3, expected_master_fee_share_3
		);
		assert!(
		...
		print!(
			"\n\nmaster_fee_share: {:?}, {:?}\n\n",
			master_fee_share_4, expected_master_fee_share_4
		);
		assert!(
			master_fee_share_4 ==
		...
		print!("Alice balance 5: {:?}", alice_balance_5);
		assert!(
		...
		print!("Bob balance 5: {:?}", bob_balance_5);
		assert!(
		...
		print!(
			"\n\nmaster_fee_share: {:?}, {:?}\n\n",
			master_fee_share_5, expected_master_fee_share_5
		);
		assert!(
			master_fee_share_5 ==
		...
		print!("Alice balance 6: {:?}", alice_balance_6);
		assert!(
		...
		print!("Bob balance 5: {:?}", bob_balance_6);
		assert!(
		...
		print!(
			"\n\nmaster_fee_share: {:?}, {:?}\n\n",
			master_fee_share_6, expected_master_fee_share_6
		);
		assert!(
			master_fee_share_6 ==
